...
# img_calibrated = np.zeros_like(mat_extracted_ref)
# _n = 0
# for _i in range(4):
#     for _j in range(6):
...
img_calibrated = func_fit(q_flat, beta, mat_m, w_avg, list_srl, np.zeros_like(mat_cc)).reshape((3, 4, 6)).transpose((1, 2, 0))
